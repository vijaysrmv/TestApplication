...
;(function ($, window) {
  ...
  (function (p) {
      ...
      p.setFixedContainerWidthForVisibleScrollArrows = function () {
        ...
        stc.$fixedContainer.width(stc.fixedContainerWidth - stc.scrollArrowsCombinedWidth-getBrowserScrollSize().width-2);//Bug 83743
      };
          ...
          $tabLi.each(function () {
            var $li = $(this),
                ...
                if($li.css('display')!="none"){
                    ...
                    stc.movableContainerWidth += ($li[0].getBoundingClientRect().width + totalMargin);
                }
          });
  
          stc.movableContainerWidth += 2;
  ...
  (function (p) {
    p.initTabs = function (options, $scroller, readyCallback, attachTabContentToDomCallback) {
      ...
      if (options.reverseScroll || $('html').attr('dir') === 'RTL') {
  ...
  var tabElements = (function () {
    ...
    function getNewElTabAnchor(tab, propNames) {
      return $('<a role="tab" data-bs-toggle="tab"></a>')
  ...
  function checkForTabPropertiesUpdated(refreshData) {
    ...
    if (origTabData[propNames.disabled] !== newTabData[propNames.disabled]) {
      if (newTabData[propNames.disabled]) { // enabled -> disabled
        $li.addClass('disabled');
        $li.find('a[role="tab"]').attr('data-bs-toggle', '');
      } else { // disabled -> enabled
        $li.removeClass('disabled');
        $li.find('a[role="tab"]').attr('data-bs-toggle', 'tab');
      }
